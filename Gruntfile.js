    ...
    copy: {
      prod: {
        files: [
          ...
          { src: ['src/js/lib/jquery-1.8.0.js'], dest: 'dest/prod/js/lib/jquery-1.8.0.js' },
          { expand: true, src: ['img/**'], cwd: 'src/', dest: 'dest/prod/', filter: 'isFile' },
          { expand: true, src: ['css/fonts/**'], cwd: 'src/', dest: 'dest/prod/', filter: 'isFile' },
        ],
        // files: [
        //   {expand: true, src: ['**/*'], cwd: 'dest/prod/', dest: '../piskel-test/'}
        // ]
      },
      friends: {
        files: [
          { expand: true, src: ['**/*'], cwd: 'dest/prod/', dest: '../piskel/' }
        ]
      },
      dev: {
        files: [
